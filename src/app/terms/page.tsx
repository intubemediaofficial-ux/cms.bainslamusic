        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 sm:p-10">
          ...
          <div className="space-y-9 text-slate-700 leading-7">
            <section>
              ...
              <p>
                These Terms govern use of Bainsla Music at cms.bainslamusic.com. Bainsla Music provides
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>You may authenticate your CMS account using a local Bainsla Music email/password or Google Sign-In.</li>
                <li>A local CMS password is separate from your Google and YouTube credentials. You must never enter a Google or YouTube password into an Bainsla Music email/password field.</li>
                <li>Google Sign-In and YouTube channel authorization are hosted by Google. Bainsla Music does not receive or store your Google password.</li>
            ...
            <section>
              ...
              <p className="mb-3">
                Bainsla Music uses Google-hosted OAuth 2.0, the YouTube Data API, and the YouTube Analytics
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>Authorization is channel-specific. Bainsla Music verifies the Google-returned channel ID against the assigned CMS channel and rejects mismatches.</li>
            ...
            <section>
              ...
              <p>
                Bainsla Music does not silently edit or delete YouTube videos. An authorized user must
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>You may revoke channel access through Bainsla Music&apos;s Revoke Access, delink, or remove controls.</li>
                ...
                <li>You may also revoke access through <a className={externalLinkClass} href="https://security.google.com/settings/security/permissions" target="_blank" rel="noopener noreferrer">Google Account permissions</a>. Bainsla Music detects invalid authorization during scheduled refresh/API revalidation and deletes related authorized data.</li>
            ...
            <section>
              ...
              <p>
                ...
                Current-month figures may be incomplete. Bainsla Music may keep monthly caches while
            ...
            <section>
              ...
              <p>
                Bainsla Music&apos;s use and transfer of information received from Google APIs adheres to the{" "}
            ...
            <section>
              ...
              <p>
                ...
                <a className={externalLinkClass} href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">Google Privacy Policy</a>, and applicable Google/YouTube API terms and policies. Google and YouTube may change, limit, or discontinue APIs independently of Bainsla Music.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                Bainsla Music does not guarantee uninterrupted API availability, exact real-time analytics,
                ...
                law, Bainsla Music is not liable for indirect or consequential loss caused by third-party API
